                ...
                <ul className="mt-5 grid gap-2 sm:grid-cols-2">
                  {(it
                    ? [
                        ...
                        "Unione di viaggi consecutivi (soste intermedie, un unico percorso)",
                        "Storico degli ultimi 7 giorni consultabile",
                    ...
                    : [
                        ...
                        "Merge consecutive trips (intermediate stops, one journey)",
                        "7-day browsable trip history",
            ...
            <ul className="mt-5 space-y-2">
              {(it
                ? [
                    ...
                    "Export GPX completo con estensioni (CSV e PDF 🔜 in arrivo)",
                ...
                : [
                    ...
                    "Full GPX export with extensions (CSV & PDF 🔜 coming soon)",
