...
export const it = {
  ...
  "admin.vinToolsTitle": "Strumenti VIN",
  "admin.vinToolsHint": "Cerca un VIN per vedere quale account lo ha reclamato, e sganciarlo se un utente segnala di non riuscire ad associare la propria auto reale.",
  "admin.vinToolsPlaceholder": "Cerca per VIN...",
  "admin.search": "Cerca",
  "admin.searching": "Ricerca...",
  "admin.vinNotFound": "Nessun veicolo ha reclamato questo VIN",
  "admin.errVinLookup": "Errore nella ricerca del VIN",
  "admin.vinFieldVin": "VIN",
  "admin.vinFieldNickname": "Nome veicolo",
  "admin.vinFieldOwner": "Proprietario",
  "admin.vinFieldClaimedAt": "Reclamato il",
  "admin.unlinkVehicle": "Sgancia veicolo",
  "admin.unlinking": "Sgancio...",
  "admin.confirmUnlinkVehicle": "Sganciare il VIN {{vin}} dall'account {{email}}? Il veicolo e tutti i suoi viaggi verranno eliminati, e il VIN tornerà associabile a un nuovo account.",
  "admin.vehicleUnlinked": "Veicolo sganciato. Il VIN può ora essere associato a un nuovo account.",
  "admin.errUnlinkVehicle": "Errore nello sganciare il veicolo",
  ...
  "admin.testEmailTitle": "Test & Anteprima Template Email",
  "admin.testEmailDesc": "Invia un'email di prova utilizzando i template ufficiali JaeDrive per verificare la resa grafica HTML ed i testi in lingua.",
  "admin.testEmailTemplate": "Template da Testare",
  "admin.testEmailRecipient": "Email Destinatario",
  "admin.testEmailLang": "Lingua Email",
  "admin.testEmailSend": "Invia Email di Test",
  "admin.testEmailSending": "Invio in corso...",
  "admin.testEmailSuccess": "Email di test inviata con successo a {email}!",
  "admin.testEmailError": "Errore durante l'invio dell'email di test.",
  "admin.tplSubActivated": "🎉 Abbonamento Attivato",
  "admin.tplSubRenewed": "✨ Abbonamento Rinnovato",
  "admin.tplSubExpiring": "⚠️ Abbonamento in Scadenza",
  "admin.tplSubExpired": "❌ Abbonamento Scaduto",
  "admin.tplNewPairing": "🚗 Nuovo Pairing Auto",
